...
<div class="container">
	<div class="row">
		<div class="col-lg-12">
			...
			<a target="_blank" href="./reportesEmpleados.php"><button id="btnReportes" type="button" class="btn btn-secondary"><i class="material-icons"><span class="material-symbols-outlined">
							picture_as_pdf
						</span></i></button> </a>
		</div>
	</div>
