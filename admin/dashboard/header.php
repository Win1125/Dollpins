...
$tipoEmpleado = $_SESSION['tipoEmpleado'];
	...
	<div id="wrapper">
		...
		<ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
				...
				<div class="sidebar-brand-text mx-2">Dollpins</div>
			</a>

			<hr class="sidebar-divider my-0">
			<!-- Nav Item - Dashboard -->
			<li class="nav-item active">
				<a class="nav-link" href="http://localhost/Dollpins/index.php" target="_blank">
					<i class="fa-solid fa-eye"></i>
					<span>Ver Página WEB</span></a>
			</li>
				...
				<li class="nav-item">
					...
					<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
						<div class="bg-white py-2 collapse-inner rounded">
							...
							<a class="collapse-item" href="cargos.php">Cargos</a>
						</div>
					</div>
				</li>
			<?php } ?>
			<!-- Gestion Tienda -->
			<hr class="sidebar-divider">
			<div class="sidebar-heading">Gestión de Tienda</div>
			...
			<!-- Boton para ocultar barra lateral -->
